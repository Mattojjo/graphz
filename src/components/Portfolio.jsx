    ...
    return (
        <div className="min-w-0 overflow-hidden rounded-xl border border-white/10 bg-white/5 p-5 transition-transform duration-500 ease-in-out" style={{ transformOrigin: 'top' }}>
            ...
            <div className="grid min-w-0 grid-cols-1 gap-3.5 sm:grid-cols-2 mb-7">
                <div className="group relative overflow-hidden rounded-lg border border-white/10 bg-white/5 p-4 transition-colors duration-200 hover:bg-white/10 hover:border-white/20">
                ...
                <div
                    className={`group relative overflow-hidden rounded-lg border border-white/10 bg-white/5 p-4 transition-colors duration-200 hover:bg-white/10 hover:border-white/20`}
                >
                    <span className="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-[#8b9dc3] to-[#9b8fb5] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                    ...
                    <div className="flex flex-col gap-2">
                        {holdings.map(holding => {
                            ...
                            return (
                                <div
                                    key={holding.symbol}
                                    className="relative overflow-visible rounded-lg border border-white/10 bg-white/5 p-3 transition-colors duration-200 hover:bg-white/10 hover:border-white/30"
                                >
                                    ...
                                    <div className="mt-3 flex flex-col gap-3 border-t border-white/10 pt-3 sm:flex-row sm:items-center">
                                        <div className="flex flex-col gap-1 text-xs text-zinc-400">
                                            ...
                                            <div className="grid grid-cols-[32px_50px_32px] gap-1.5">
                                                <button
                                                    ...
                                                    className="flex h-8 w-8 items-center justify-center rounded-md border border-white/20 bg-white/10 text-sm text-white transition-colors duration-200 hover:border-white/40 hover:bg-white/20 active:opacity-90"
                                                >
                                                    -
                                                </button>
                                                <input
                                        ...
                                        <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:gap-2">
                                            <button
                                                className="flex-1 rounded-md bg-gradient-to-br from-[#5fb878] to-[#6ec282] px-3 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-white transition-colors duration-200 hover:border-white/30 disabled:cursor-not-allowed disabled:opacity-40"
                                            ...
                                            <button
                                                className="flex-1 rounded-md bg-gradient-to-br from-[#e4726f] to-[#e88683] px-3 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-white transition-colors duration-200 hover:border-white/30 disabled:cursor-not-allowed disabled:opacity-40"
